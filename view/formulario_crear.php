...
<body>
    ...
    <br><br>
    <form action="../processes/insert.upload.proc.php" method="post" enctype="multipart/form-data" width="100%">
        ...
        <p>Capacidad evento: <input type="number" name="max_participantes_ev" size="6"></p>
    ...
    echo "</tr>";
        ...
        foreach ($listafotos as $foto) {
                ...
                echo "<td>{$foto['max_participantes_ev']}</td>";
