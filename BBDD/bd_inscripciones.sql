...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2021 a las 18:54:05
...
(1, 'Cursa dels Nassos', 'La Cursa dels Nassos es una carrera atlética de carácter popular, de 10 kilómetros de recorrido, que tiene lugar el 31 de diciembre de cada año (día de San Silvestre) en Barcelona, España. Empezó a disputarse en 1999 como San Silvestre Barcelonesa, hasta que en 2004 tomó la denominación actual. La carrera está organizada por el Ayuntamiento de Barcelona, a través del Institut Barcelona Esports, y cuenta con la dirección técnica de la Agrupació Atlètica Catalunya.', '../img/25-11-21-cursa_nassos.png', 18, 10000, '2021-12-31', 'Calle de Selva de Mar', 932812841),
...
(3, 'Cursa de les Empreses', '!Ya tenemos fecha para la Cursa de les Empreses!El 17 de diciembre de 2021 no dudes en participar con tus compañeros de trabajo en una prueba que te hará disfrutar de un recorrido llano y sin dificultad técnica.Compite por equipos de 2, 3 o 4 participantes de la misma empresa, o si eres más atrevido corre con traje de manera individual en la categoría executive!¡Una experiencia difícil de repetir y que hacen que la prueba se convierta en única!', '../img/25-11-21-cursa_empreses.jpg', 18, 35000, '2021-12-17', 'Plaza Europa', 931594040),
(4, 'Maratón de Barcelona', 'Corre el maratón más mágico y completo del mundo: urbano, animado, mediterráneo, monumental, escénico, rápido y accesible para todos/as.', '../img/26-11-21-marato_bcn_cursa.png', 18, 4, '2022-04-03', 'Plaça Espanya', 934315533);
...
INSERT INTO `tbl_usuarios` (`dni_usu`, `nombre_usu`, `apellido_usu`, `edad_usu`, `email_usu`, `img_dni_usu`) VALUES
('46480113B', 'Marc', 'Ortiz', 18, '7100.joan23@fje.edu', '../img/dni/3-12-21-horariodaw2.jpg'),
('46491116C', 'Miguel', 'Gras', 20, 'm@gmail.com', '../img/dni/3-12-21-1556725188.jpg');
...
INSERT INTO `tbl_voluntarios` (`id_par`, `dni_par`, `evento_par`, `id_ev`) VALUES
(1, '46491116C', 'Cursa dels Nassos', 1),
(2, '46491116C', 'La Cursa El Corte Inglés', 2),
(3, '46480113B', 'La Cursa El Corte Inglés', 2),
(4, '46480113B', 'Maratón de Barcelona', 4);
...
--
ALTER TABLE `tbl_voluntarios`
  MODIFY `id_par` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
